...
<header>
      ...
      <section class="admin-artikel">
        ...
        <div class="admin-post">
            ...
            <div class="admin-isi">
            <h2 class="title">
                    <span class="title-word title-word-1">Edit</span>
                    <span class="title-word title-word-2">User</span>
                      
                  </h2>

                <form action="add-user-logic.php" class="form-add-post" method="post">
                ...
                <?php
                    ...
                    $id     =   $_GET['id_user'];
                    $data   =   mysqli_query($varkoneksi,"SELECT * from user where id_user='$id'");
                ...
                ?>
                  ...
                  <input type="text" name="fullname" id="" placeholder="NAma Lengkap" class="judul-artikel" value="<?= $d['fullname']; ?>">
                  <br>
                  <input type="text" name="username" id="" placeholder="Username" class="judul-artikel" value="<?= $d['username']; ?>">
                  <br>
                  <input type="email" name="email" id="" placeholder="*******gmail.com*@" class="judul-artikel" value="<?= $d['email']; ?>">
                  <br>
                  <input type="password" name="password" id="" placeholder="Buat Password Baru" class="judul-artikel" value="<?= $d['password']; ?>">
                  <br>
              
                  <select class="genre" name="userrole">
                  ...
                  <div class="avatar-mainlego">
                  <p class="masukkanfoto">
                      Masukkan Foto Sebagai Avatar
                    </p>
                        <input class="user-avatar-img"type="file" name="" id="avatar" placeholder="Pilih Foto" <?= $d['avatar']; ?>>                     
                  </div>
