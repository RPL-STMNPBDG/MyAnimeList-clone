      ...
      <section class="admin-artikel">
        ...
        <div class="admin-post">
            ...
            <div class="admin-isi">
                ...
                <form action="add-post-logic.php" class="form-add-post" method="post" enctype="multipart/form-data">
                  <input type="text" name="tambah-post" id="" placeholder="Judul Artikel" class="judul-artikel">
                  <br>

                  <input type="date" name="time-post" id="" placeholder="Tanggal Post" class="judul-artikel">
                  <br>
                ...
                <br>
                  ...
                  <textarea class="text-area"name="isi-artikel" id="" cols="30" rows="10" placeholder="Isi Artikel"></textarea>

                  <div class="avatar-mainlego">
                  <p class="masukkanfoto">
                      Masukkan Foto Sebagai Thumbnail
                    </p>
                        <input class="user-avatar-img"type="file" name="emaill" placeholder="Pilih Foto">                     
                  </div>
