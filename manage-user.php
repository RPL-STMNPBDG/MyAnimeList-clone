        ...
        <div class="admin-post">
            ...
            <div class="admin-isi">
                    ...
                    <h2 class="title">
                        ...
                        <span class="title-word title-word-2">Users</span>
                    ...
                    <?php  
                          ...
                          {         
                              echo "<tr>";
                                  ...
                                  echo "<td class='edit2'><a class='button-edit' href=edit-user.php?id_user=$user_data[id_user]>Edit</a>"; 
                                  
                                  echo "<td class='edit2'><a class='button-delete' href=delete-user.php?id_user=$user_data[id_user] onclick='return confirm(`Apa Anda yakin akan menghapus User Berikut?`)'>Delete</a>";
                              echo "</tr>";     
                          }
                      ?>
