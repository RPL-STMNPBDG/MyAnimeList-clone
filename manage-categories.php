<?php
    ...
    $result = mysqli_query($varkoneksi, "SELECT * FROM genre ORDER BY id_genre ASC");
?>
      ...
      <section class="admin-artikel">
        ...
        <div class="admin-post">
            ...
            <div class="admin-isi">
                    ...
                    <h2 class="title">
                        <span class="title-word title-word-1">Pengaturan</span>
                ...
                <table>
                    ...
                    <?php  
                          ...
                          {         
                              echo "<tr>";
                              echo "<td>".$user_data['id_genre']."</td>";

                                  echo "<td>".$user_data['judul_genre']."</td>";
                                   
                                  echo "<td class='edit2'><a class='button-edit' href=edit-categories.php?id_genre=$user_data[id_genre]>Edit</a>"; 
                                  
                                  echo "<td class='edit2'><a class='button-delete' href=delete-categories.php?id_genre=$user_data[id_genre] onclick='return confirm(`Apa Anda yakin akan menghapus Kategori Berikut??`)'>Hapus</a>";
                              echo "</tr>";     
                          }
                      ?>
