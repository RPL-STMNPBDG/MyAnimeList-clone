      ...
      <section class="admin-artikel">
        ...
        <div class="admin-post">
            ...
            <h2 class="title">
                ...
                <form action="edit-categories-logic.php" class="form-add-post" method="post">
                ...
                <?php
                    ...
                    $id     =   $_GET['id_genre'];
                    $data   =   mysqli_query($varkoneksi,"SELECT * from genre where id_genre='$id'");
                ...
                ?>
                  ...
                  <input type="text" name="judulgenre" placeholder="Nama Genre" class="judul-artikel" value="<?= $d['judul_genre']; ?>">
                  <br>
       
                  <textarea class="text-area"name="deskripsi" cols="30" rows="10" placeholder="Deskripsi Genre">
                  <?= $d['deskripsi']; ?>
                  </textarea>
