      ...
      <section class="admin-artikel">
        ...
        <div class="admin-post">
            ...
            <h2 class="title">
                ...
                <form action="add-user-logic.php" class="form-add-post" method="post" enctype="multipart/form-data">
                  <input type="text" name="fullname" id="" placeholder="NAma Lengkap" class="judul-artikel">
                  <br>
                  <input type="text" name="username" id="" placeholder="Username" class="judul-artikel">
                  <br>
                  <input type="email" name="email" id="" placeholder="*******gmail.com*@" class="judul-artikel">
                  <br>
                  <input type="password" name="password" id="" placeholder="Buat Password Baru" class="judul-artikel">
                  <br>
