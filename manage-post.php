<?php
    ...
    $result = mysqli_query($varkoneksi, "SELECT * FROM artikel ORDER BY id_artikel ASC");
?>
      ...
      <section class="admin-artikel">
        ...
        <div class="admin-post">
            ...
            <div class="admin-isi">
                    ...
                    <h2 class="title">
                        <span class="title-word title-word-1">Manage</span>
                ...
                <table>
                    <thead>
                        <tr>
                            <th class="edit2">Title</th>
                            <th class="edit2">Genre</th>
                            <th class="edit2">
                                Edit
                            </th>
                            <th class="edit2">
                    ...
                    <tbody>
                      ...
                      <?php  
                          ...
                          {         
                              echo "<tr>";
                                  echo "<td>".$user_data['judul_artikel']."</td>";
                                  echo "<td>".$user_data['genre_artikel']."</td>";
                                   
                                  echo "<td class='edit2'><a class='button-edit' href=edit-post.php?id_artikel=$user_data[id_artikel]>Edit</a>"; 
                                  
                                  echo "<td class='edit2'><a class='button-delete' href=delete-post.php?id_artikel=$user_data[id_artikel] onclick='return confirm(`Apa Anda yakin akan menghapus Artikel Berikut??`)'>Delete</a>";
                              echo "</tr>";     
                          }
                      ?>
