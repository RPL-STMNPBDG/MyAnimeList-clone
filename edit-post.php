            ...
            background: linear-gradient(252deg, rgba(0,0,0,0) 14%, rgba(73,12,149,1) 48%, rgba(0,0,0,1) 75%); margin-top: 5px; margin-left:15px;">
              ...
              <button
                style="margin-left: 80%;" 
                  ...
                  aria-controls="dropdown1"  
                >
                  <img src="img/meddie.jpg" alt="" width="10%" >  
                </button>
                <ul class="dropdown" id="dropdown1">
        ...
        <div class="admin-post">
            ...
            <div class="admin-isi">
                <h2 class="title">
                    ...
                    <span class="title-word title-word-2">Post</span>
                ...
                <form action="add-post-logic.php" class="form-add-post" method="post">
                ...
                <?php
                    ...
                    $id     =   $_GET['id_artikel'];
                    $data   =   mysqli_query($varkoneksi,"SELECT * from artikel where id_artikel='$id'");
                ...
                ?>
                  ...
                  <input type="text" name="tambah-post" id="" class="judul-artikel" placeholder="<?= $d['judul_artikel']; ?>">
                  <br>

                  <select name="genrerole" class="genre">
                    <option>Genre</option>
                    ...
                    <?php
                        ...
                        {
                    ?>    
                        <option value="<?php echo $siswa_data['judul_genre']?>"><?php echo $siswa_data['judul_genre']?></option>
                ...
                <br>
                  ...
                  <textarea class="text-area"name="isi-artikel" id="" cols="30" rows="10" placeholder="<?= $d['isi_artikel']; ?>"></textarea>

                  <div class="avatar-mainlego">
                  <p class="masukkanfoto">
                      Masukkan Foto Sebagai Thumbnail
                    </p>
                        <input class="user-avatar-img"type="file" name="avatar" id="avatar" placeholder="Pilih Foto" value="<?= $d['avatar_artikel']; ?>">                     
                  </div>
